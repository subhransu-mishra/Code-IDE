  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row">
        <div className={`left ${isExpanded ? "w-full" : "w-full md:w-1/2"}`}>
            ...
            <div className="tabs flex items-center gap-2">
              {['html', 'css', 'js'].map(lang => (
                <div
                  key={lang}
                  onClick={() => setTab(lang)}
                  className="tab cursor-pointer p-[6px] bg-[#1E1E1E] px-[10px] text-sm md:text-base"
                >
                  {lang.toUpperCase()}
                </div>
              ))}
          ...
          <Editor
            ...
            height={isExpanded ? (isMobile ? "90vh" : "82vh") : (isMobile ? "50vh" : "82vh")}
